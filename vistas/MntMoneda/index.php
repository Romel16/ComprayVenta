<?php
    ...
    $rol = new RolModels();
    $datos = $rol->validar_acceso_rol($_SESSION["usuarioId"],"mntmoneda");
...
<head>
    <title>Punto de Venta | Moneda</title>
...
<body>
    ...
    <?php require_once("mantenimientoMoneda.php"); ?>
