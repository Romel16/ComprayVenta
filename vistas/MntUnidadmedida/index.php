<?php
    ...
    $rol = new RolModels();
    $datos = $rol->validar_acceso_rol($_SESSION["usuarioId"],"mntundmedida");
...
<head>
    <title>Punto de Venta | Unidad de Medida</title>
...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <!-- TODO: Tabla de Unidad de Medida -->
    ...
    <?php require_once("mantenimientoUnidad.php"); ?>
    ...
    <script type="text/javascript" src="mntunidmedida.js"></script>
</body>
